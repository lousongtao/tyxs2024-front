...
const PopsciMgmtIndividualModal = (props) => {
        ...
        <Row>
          ...
          <Col span={12}>
            <Form.Item name="gender" label="性别" rules={[{required: true,message: '请选择性别'}]} >
              <Select style={{width:200}} disabled={props.viewMode}>
        ...
        <Row>
          <Col span={12}>
            <Form.Item
              name="address"
              label="通讯地址"
              rules={[{required: true,message: '请选择通讯地址'}]}>
              <Input style={{width:400}} disabled={props.viewMode}/>
            </Form.Item>
          </Col>
        </Row>
        <Row>
          <Col span={12}>
            <Form.Item
              name="email"
              label="电子邮箱"
              rules={[{required: true,message: '请选择电子信箱'}]}>
              <Input style={{width:200}} disabled={props.viewMode}/>
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item
              name="domain"
              label="从事专业/领域"
              rules={[{required: true,message: '请选择从事专业/领域'}]}>
              <Input style={{width:200}} disabled={props.viewMode}/>
            </Form.Item>
          </Col>
        </Row>
        ...
        <Card title="申报人情况" bordered={false} style={{ width: '100%' }}>
          <Form.Item name="projectBrief" label="项目综述" labelCol={4} wrapperCol={20}
            ...
            <Input.TextArea
              ...
              rows={6}
              maxLength={500}
              placeholder="请高度概括项目申报人的相关健康科普管理工作的特色和亮点"
              disabled={props.viewMode}/>
          </Form.Item>
          <Form.Item name="projectDesc" label="项目介绍" labelCol={4} wrapperCol={20}
            ...
            <Input.TextArea
              ...
              rows={14}
              maxLength={2000}
              placeholder="请详细说明项目申报人的相关健康科普管理实绩情况，包括但不限于：科普项目，科普成果，科普队伍建设等方面，以及项目产生的社会效益等"
              disabled={props.viewMode} />
          </Form.Item>
        </Card>
      </Form>
...
export default PopsciMgmtIndividualModal;
